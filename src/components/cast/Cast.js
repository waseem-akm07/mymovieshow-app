...
import { BASE_URL, API_KEY, CAST_CREW } from '../../constants/Constant';
            ...
            <div>
                ...
                <div class="row">
                    <div class="column left" style={{ "background-color": "#aaa;" }}>
                        <img src={"http://image.tmdb.org/t/p/w185/" + this.props.history.location.state.profile_path}
                            alt="Loading..." style={{ "width": "100%", "min-height": "200px", "max-height": "290px" }} />
                    </div>

                    <div class="column right" style={{ "background-color": "#bbb" }}>
                        <h3> {this.props.history.location.state.name}</h3>
                        <b>Character: </b> {this.props.history.location.state.character}<br />
                    </div>
                </div >
